...
export const Button: React.FC<ButtonProps> = ({
  ...
  const variants = {
    primary: 'bg-blue-600 hover:bg-blue-700 text-white focus:ring-blue-500 shadow-sm shadow-blue-100',
    ...
    danger: 'bg-red-600 hover:bg-red-700 text-white focus:ring-red-500 shadow-sm shadow-red-100',
  ...
  return (
    <button disabled={disabled || isLoading} className={combinedClasses} {...props}>
      {isLoading ? (
        <>
